...
import type { CreateWebhookRequest, UpdateWebhookRequest } from '@nuntly/sdk';
...
eventsSub
  ...
  .action(async (id, eventId, opts, cmd) => {
    try {
...
webhooksCommand
  ...
  .action(async (id, opts, cmd) => {
    try {
      ...
      if (!await confirmDelete('webhooks', id, !!globals.yes)) return;
